 ...
 */
package edu.snu.cay.dolphin.pregel.graphapps.shortestpath;

import edu.snu.cay.dolphin.pregel.PregelConfiguration;
import edu.snu.cay.dolphin.pregel.combiner.MinimumLongMessageCombiner;
import edu.snu.cay.dolphin.pregel.common.DefaultEdgeCodec;
import edu.snu.cay.dolphin.pregel.common.DefaultGraphParser;
...
public final class ShortestPathJob {
   ...
   */
  private ShortestPathJob() {

  }

  public static void main(final String[] args) throws IOException, InjectionException {
    PregelJobLauncher.submitJob(ShortestPathJob.class.getSimpleName(), args, PregelConfiguration.newBuilder()
