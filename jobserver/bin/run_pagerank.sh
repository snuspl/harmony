...
# EXAMPLE USAGE
# ./run_pagerank.sh -local true -max_num_eval_local 3 -num_pregel_workers 3 -input file://$(pwd)/inputs/adj_list -pregel_worker_mem_size 128 -pregel_worker_num_cores 1 -driver_memory 128 -timeout 300000
