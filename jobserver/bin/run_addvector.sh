...
# EXAMPLE USAGE
# ./run_addvector.sh -num_dolphin_workers 3 -num_servers 2 -max_num_epochs 10 -num_mini_batches 15 -num_worker_blocks 15 -delta 4 -num_keys 100 -num_training_data 50 -num_test_data 5 -compute_time_ms 30 -vector_size 5 -max_num_eval_local 5 -input run_addvector.sh -optimizer edu.snu.cay.dolphin.optimizer.impl.EmptyPlanOptimizer -optimization_interval_ms 3000 -delay_after_optimization_ms 10000 -server_metric_flush_period_ms 1000 -num_initial_batch_metrics_to_skip 3 -min_num_required_batch_metrics 3
...
ALG=edu.snu.cay.dolphin.examples.addvector.AddVectorET
