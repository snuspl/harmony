...
/**
 * Codec for message, which is composed of {@link PregelParameters.MessageValueCodec}.
 *
...
public final class MessageCodec<M> implements Codec<Iterable<M>>, StreamingCodec<Iterable<M>> {
  ...
  @Inject
  private MessageCodec(@Parameter(PregelParameters.MessageValueCodec.class) final StreamingCodec<M> valueCodec) {
