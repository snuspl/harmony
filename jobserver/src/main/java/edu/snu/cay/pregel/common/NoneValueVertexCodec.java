...
import edu.snu.cay.pregel.graph.impl.NoneValueVertex;
...
public final class NoneValueVertexCodec<E> implements Codec<Vertex<Void, E>> {
  ...
  @Inject
  private NoneValueVertexCodec(@Parameter(PregelParameters.EdgeCodec.class) final StreamingCodec<Edge<E>> edgeCodec) {
