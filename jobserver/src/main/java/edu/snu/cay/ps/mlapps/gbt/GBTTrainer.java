 ...
 */
package edu.snu.cay.ps.mlapps.gbt;

import edu.snu.cay.common.math.linalg.Vector;
import edu.snu.cay.ps.core.worker.ETModelAccessor;
...
import edu.snu.cay.ps.mlapps.gbt.tree.*;
...
final class GBTTrainer implements Trainer<GBTData> {
  ...
  private GBTTrainer(final ModelAccessor<Integer, GBTree, List<GBTree>> modelAccessor,
                     @Parameter(DolphinParameters.NumFeatures.class) final int numFeatures,
