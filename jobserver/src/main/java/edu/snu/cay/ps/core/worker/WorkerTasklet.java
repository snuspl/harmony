...
import edu.snu.cay.ps.metric.avro.BatchMetrics;
import edu.snu.cay.ps.metric.avro.DolphinWorkerMetrics;
import edu.snu.cay.ps.metric.avro.EpochMetrics;
import edu.snu.cay.ps.metric.avro.WorkerMetricsType;
