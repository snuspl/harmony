 ...
 */
package edu.snu.cay.ps.mlapps.nmf;
...
final class NMFModelGenerator {
  ...
  private NMFModelGenerator(final VectorFactory vectorFactory,
                            ...
                            @Parameter(NMFParameters.InitialMax.class) final float initMax,
                            @Parameter(NMFParameters.InitialMin.class) final float initMin,
                            @Parameter(NMFParameters.MaxValue.class) final Float maxVal) {
  ...
  /**
   * Returns a new random vector with length {@link NMFParameters.Rank}.
   * Elements are randomly generated in range [{@link NMFParameters.InitialMin}, {@link NMFParameters.InitialMax}].
